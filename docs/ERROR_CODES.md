...
| `LNS-REL-007` | Error | Build, instalação, smoke ou remoção nativa x64/ARM64 falhou, ou a evidência/atestação nativa está ausente, inválida ou incoerente; inclui `CreateProcess 4551` quando App Control bloqueia o executável de QA antes do arranque | Corrija o pacote ou a cadeia de evidência exata; para `4551`, use Authenticode confiável ou peça autorização ao administrador sem desativar a política. Um cross-build x64 não substitui este gate. |
